...
class ChatGPTDocstringGenerator:
    ...
    def generate_function_docstring(self, source: str) -> dict:
        ...
        """
        prompt = f"""
        Your task is to generate a detailed and technical google style docstring for the function delimited
        by triple quotes. Store this docstring inside a JSON, with a key names 'docstring'.
