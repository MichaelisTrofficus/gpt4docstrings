...
class ChatGPTDocstringGenerator:
    ...
    def generate_function_docstring(self, source: str) -> dict:
        ...
        """
        prompt = f"""
        Your task is to generate a detailed and technical {self.docstrings_style} docstring for the function
    ...
    def generate_class_docstring(self, source: str) -> dict:
        ...
        """
        prompt = """
        Your task is to generate an detailed and technical {} docstring for the class delimited by triple
